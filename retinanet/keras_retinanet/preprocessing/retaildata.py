"""
Wrtitten by shibintv.
contact: shibintv@tamu.edu
"""
...
class RetailGenerator(Generator):
    ...
    """
        Special initalization to setup the same directory structure as coco.
    ...
    def __init__(self, data_dir, set_name, **kwargs):
        ...
        super(RetailGenerator, self).__init__(**kwargs)
